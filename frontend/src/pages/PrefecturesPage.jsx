...
export default function PrefecturesPage() {
  ...
  return (
    <section className="page page--discovery discovery-page--compact-hero prefectures-page">
      <PageHero
        eyebrow="Forty-seven stories"
        title="Japan’s prefectures"
        subtitle="Search and compare every prefecture by region, rating, and community contributions."
      />
      <div className="filters">
        <label>
          ...
          <input
            ...
            placeholder="Prefecture or region"
          />
        </label>
        <label>
          Region
      ...
      {loading ? (
        ...
        <section className="discovery-results">
          <header>
            <div>
              <p className="eyebrow">Browse the map</p>
        ...
        <EmptyState title="No prefectures match" message="Try widening your filters." />
      )}
    </section>
  )
}
