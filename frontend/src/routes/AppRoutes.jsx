  ...
  return (
    <Routes>
      <Route element={<SiteLayout />}>
        ...
        <Route path="prefectures" element={<PrefecturesPage />} />
        <Route path="prefectures/:name" element={<PrefectureDetailPage />} />
        <Route path="places" element={<PlacesPage />} />
        <Route path="places/:id/:slug?" element={<PlaceDetailPage />} />
        <Route path="places/new" element={protectedPage(<PlaceFormPage />)} />
        <Route path="places/:id/edit" element={protectedPage(<PlaceFormPage />)} />
        <Route path="places/:placeId/reviews/new" element={protectedPage(<ReviewFormPage />)} />
        <Route path="reviews/:reviewId/edit" element={protectedPage(<ReviewFormPage />)} />
        <Route path="contributors/:id" element={<ProfilePage />} />
        <Route path="profile/edit" element={protectedPage(<ProfileEditPage />)} />
        <Route path="my-travel" element={protectedPage(<MyTravelPage />)} />
        <Route path="search" element={<SearchPage />} />
        <Route path="support" element={<SupportJapan47Page />} />
        <Route path="delete-account" element={<DeleteAccountPage />} />
        <Route path="contact" element={protectedPage(<ContactPage />)} />
        <Route path="contact/success/:ticketId" element={protectedPage(<SupportSuccessPage />)} />
