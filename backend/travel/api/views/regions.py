...
class RegionViewSet(viewsets.ReadOnlyModelViewSet):
    ...
    def list(self, request, *args, **kwargs):
        ...
        return JsonResponse(list(self.get_serializer(regions, many=True).data), safe=False)
